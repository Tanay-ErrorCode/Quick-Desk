      ...
      const sampleNotifications: Notification[] = [
        {
          ...
          message: 'Your account has been created successfully. Start by creating your first ticket.',
          time: '2 hours ago',
          read: false,
          type: 'system'
        },
        {
          ...
          message: 'Someone replied to your question about React vs Vue.js comparison.',
          time: '1 day ago',
          read: false,
          type: 'ticket'
        },
