...
function AdminAllTicketsPage() {
  ...
  useEffect(() => {
    ...
    if (loggedIn && role === "Admin") {
      ...
      const sampleTickets: AdminTicket[] = [
        {
          ...
          description: "Cannot connect to production database, affecting all users",
          category: "Database",
          priority: "high",
          status: "open",
          author: "John Doe",
      ...
      const sampleAgents: Agent[] = [
        { id: 1, name: "Sarah Johnson", email: "sarah.johnson@company.com", activeTickets: 5 },
        { id: 2, name: "Mike Chen", email: "mike.chen@company.com", activeTickets: 3 },
        { id: 3, name: "David Kim", email: "david.kim@company.com", activeTickets: 4 },
        { id: 4, name: "Lisa Rodriguez", email: "lisa.rodriguez@company.com", activeTickets: 2 },
      ];
  ...
  const handleStatusChange = (ticketId: number, newStatus: AdminTicket["status"]) => {
    setTickets((prev) =>
      prev.map((ticket) =>
        ticket.id === ticketId
          ? {
          ...
          <Col xs={12}>
            <div className="d-flex flex-column flex-lg-row justify-content-between align-items-start align-items-lg-center gap-3">
              <div className="flex-grow-1">
                <h2 className="fw-bold text-dark mb-1">🎫 All Tickets Management</h2>
        ...
        <Row className="mb-4 g-3">
          <Col md={3} sm={6}>
            <Card className="bg-primary text-white">
              <Card.Body className="text-center p-3">
                <h3 className="mb-1">{tickets.filter(t => t.status === 'open').length}</h3>
          ...
          <Col md={3} sm={6}>
            <Card className="bg-warning text-white">
              <Card.Body className="text-center p-3">
                <h3 className="mb-1">{tickets.filter(t => t.status === 'in_progress').length}</h3>
          ...
          <Col md={3} sm={6}>
            <Card className="bg-danger text-white">
              <Card.Body className="text-center p-3">
                <h3 className="mb-1">{tickets.filter(t => t.isUrgent).length}</h3>
          ...
          <Col md={3} sm={6}>
            <Card className="bg-success text-white">
              <Card.Body className="text-center p-3">
                <h3 className="mb-1">{tickets.filter(t => t.status === 'answered' || t.status === 'closed').length}</h3>
